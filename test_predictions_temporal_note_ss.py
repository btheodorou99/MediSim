...
checkpoint = torch.load('./save/medisim_model_note_ss', map_location=torch.device(device))
...
pickle.dump(intermediate, open("./results/temporal_completion_stats/MediSim_Note_SS_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/temporal_completion_stats/MediSim_Note_SS_Metrics.pkl", "wb"))
