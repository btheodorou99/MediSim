...
pickle.dump(intermediate, open("./results/temporal_completion_stats/MediSim_Image_Base_intermediate_results_ss.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/temporal_completion_stats/MediSim_Image_Base_Metrics_ss.pkl", "wb"))
