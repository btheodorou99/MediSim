...
checkpoint = torch.load('./save/medisim_model_image_ss', map_location=torch.device(device))
...
pickle.dump(intermediate, open("./results/modality_completion_stats/MediSim_Image_SS_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/modality_completion_stats/MediSim_Image_SS_Metrics.pkl", "wb"))
