...
pickle.dump(intermediate, open("./results/temporal_completion_stats/MediSim_Image_SS_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/temporal_completion_stats/MediSim_Image_SS_Metrics.pkl", "wb"))
