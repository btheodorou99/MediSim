...
pickle.dump(intermediate, open("./results/modality_completion_stats/MediSim_Note_SS_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/modality_completion_stats/MediSim_Note_SS_Metrics.pkl", "wb"))
