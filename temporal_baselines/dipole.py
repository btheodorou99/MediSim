...
if os.path.exists("./save/temporal/dipole"):
        ...
        if i % (500*config.batch_size) == 0:
            ...
            with torch.no_grad():
                ...
                if cur_val_loss < global_loss:
                    ...
                    torch.save(state, './save/temporal/dipole')
                    print('\n------------ Save best model ------------\n')
...
pickle.dump(intermediate, open("./results/temporal_completion_stats/Dipole_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/temporal_completion_stats/Dipole_Metrics.pkl", "wb"))
