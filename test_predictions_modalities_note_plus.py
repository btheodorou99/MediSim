...
pickle.dump(intermediate, open("./results/modality_completion_stats/MediSim_Note_Plus_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/modality_completion_stats/MediSim_Note_Plus_Metrics.pkl", "wb"))
