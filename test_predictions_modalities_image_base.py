...
from model_image_base import MediSimModel
...
checkpoint = torch.load('./save/medisim_model_image_base', map_location=torch.device(device))
...
pickle.dump(intermediate, open("./results/modality_completion_stats/MediSim_Image_Base_intermediate_results.pkl", "wb"))
...
pickle.dump(metrics_dict, open("./results/modality_completion_stats/MediSim_Image_Base_Metrics.pkl", "wb"))
